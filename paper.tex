...
in Metropolis-Hastings~\cite{}
or Gibbs sampling~\cite{}.
Alternatively, samples on the chain can be generated by simulating Hamiltonian dynamics~\cite{} (instead of performing the random walk).
This approach, termed Hybrid or Hamiltonian Monte Carlo (HMC)~\cite{} was shown to converge faster to the desired distribution, when compared to random-walk based MCMC algorithms.
...
This is done using the concept of a canonical distribution from statistical mechanics~\cite{}. 
