...
Unlike a rejection sampling, MCMC does a random walk in a parametric space and concentrates on an important area, which usually brings better efficiency.
...
We can sample $ [ x ,q ] $ from $ P(x, q) $ and discard the momentum $ q $ (as an auxiliary variable) in order to sample from a marginal distribution $ P(x) $.
