...
We have a system energy $ E $ 
%\os{change to E}
of the object that consists of kinetic energy $ K $ and potential energy $ U $, which is written as $ E(x,q) = U(x) + K(q) $.
...
$ \frac{dx}{dt} = \frac{\partial E}{\partial q} $ and $ \frac{dq}{dt} = - \frac{\partial E}{\partial x} $.
%
The canonical distribution is often choose to bridge a system energy with a probability distribution, which is written as $ P(x, q) = \frac{1}{Z} \exp ( -E(x,q) / T ) $.
