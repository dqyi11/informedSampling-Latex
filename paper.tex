...
\begin{algorithm}[t]
	\begin{algorithmic}[1]
		...
		\IF{ \texttt{sample\_random}$ (0.0 , 1.0) < \alpha $  }
            \RETURN $ x'_{i} $
		\ENDIF
		\RETURN $ x_{i-1} $
	\end{algorithmic}
...
%Fig.~\ref{fig:sampling_efficiency} 
...
\bottomrule
\end{tabular}
\caption {\captionstyle Parameters for the problems. All robots have $|a_{max}| = 1.0~rad/s^2$}.
\label{tab:params} 
\end{table*}
...
%
%
%\subsubsection[\textbf{P1}]{\textbf{P1} 6 Dimension - 3 DoF Planar Manipulator}
%
