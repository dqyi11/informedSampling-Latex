...
in Metropolis-Hastings~\cite{ADDJ03} or Gibbs sampling~\cite{ADDJ03}.
Alternatively, samples on the chain can be generated by simulating Hamiltonian dynamics~\cite{N11} (instead of performing the random walk).
