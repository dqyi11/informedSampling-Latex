...
for i = 0:1:datasetSize-1
  mcmc_filename = sprintf('data/10s/simple_MCMC_%d.csv', i);
  rs_filename = sprintf('data/10s/simple_RS_%d.csv', i);
  hrs_filename = sprintf('data/10s/simple_HRS_%d.csv', i);
  hnr_filename = sprintf('data/10s/simple_HNR_%d.csv', i);
