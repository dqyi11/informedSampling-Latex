...
loglog(volumeRatio, RSTime, 'Color', red);

%h1 = loglog(data(:,5),data(:,4)./data(:,6), 'MarkerSize', marker_size, 'MarkerFaceColor', blue, 'MarkerEdgeColor', blue, 'Marker', 's');
%h2 = loglog(data(:,5),data(:,2)./data(:,6), 'MarkerSize', marker_size, 'MarkerFaceColor', red, 'MarkerEdgeColor', red, 'Marker', 'd');
%h3 = loglog(data(:,5),data(:,2)./data(:,6), 'MarkerSize', marker_size, 'MarkerFaceColor', green, 'MarkerEdgeColor', green, 'Marker', 'h');
%h4 = loglog(data(:,5),data(:,3)./data(:,6), 'MarkerSize', marker_size, 'MarkerFaceColor', purple, 'MarkerEdgeColor', purple, 'Marker', 'o');
...
%set(gca, 'XTickLabel', {'0.00001','0.0001','0.001', '0.01', '0.1'});
